...
const variants: Variant[] = [
  ...
  {
    key: "v1",
    name: "変更1: ネイビー × オフホワイト",
    mood: "信頼感、企業らしさ。シアンが最も映える",
    bg: "#FAFBFC",
    dark: "#0E2238",
    cyan: "#4AB8D8",
  ...
  {
    key: "v2",
    name: "変更2: ダークスレート × アイボリー",
    mood: "暖色背景 × 寒色文字、柔らかく上品",
    bg: "#F8F5EE",
    dark: "#1A2330",
    cyan: "#4AB8D8",
    muted: "rgba(26,35,48,0.45)",
    mutedStrong: "rgba(26,35,48,0.65)",
    border: "rgba(26,35,48,0.08)",
  },
  {
    key: "v3",
    name: "変更3: ダーク × シアン",
