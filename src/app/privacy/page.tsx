...
・業務委託先に業務を委託する場合（この場合、委託先に対して適切な管理・監督を行います）`,
  },
  {
    number: "第5条",
    title: "個人情報の安全管理",
    content: `当社は、個人情報の紛失、破壊、改ざん、漏洩等を防ぐため、適切なセキュリティ対策を実施します。ウェブサイトを通じて個人情報をご提供いただく際は、SSL（暗号化通信）を利用し、安全性の確保に努めます。また、個人情報を取り扱う従業員に対して、個人情報保護に関する適切な教育・監督を行います。`,
  },
  {
    number: "第6条",
    title: "個人情報の開示・訂正・削除",
    content: `ご本人から個人情報の開示・訂正・削除等のご請求をいただいた場合、合理的な期間内に対応いたします。ご請求の際は、本人確認を行うため、所定の手続きをお願いする場合があります。具体的な手続きにつきましては、第9条のお問い合わせ窓口までご連絡ください。`,
  },
  {
    number: "第7条",
    title: "Cookieの使用およびアクセス解析について",
    content: `当社のウェブサイトでは、利便性向上・アクセス解析のためにCookieを使用することがあります。ブラウザの設定によりCookieを無効にすることが可能ですが、一部のサービスが正常にご利用いただけなくなる場合があります。

また、当社ではウェブサイトの利用状況を把握するためにGoogle Analyticsを利用しています。Google AnalyticsはCookieを利用してデータを収集しますが、これには個人を特定する情報は含まれません。この機能はCookieを無効にすることで収集を拒否することができます。詳細については、Googleのポリシーと規約のページをご覧ください。`,
  },
  {
    number: "第8条",
    title: "プライバシーポリシーの変更",
...
株式会社ディーケー
〒860-0833 熊本県熊本市南区平成2丁目5番11号 DKビル2F
メールアドレス：recruit@dk311.jp`,
  },
];
      ...
      <section className="pb-32 bg-white">
        <div className="max-w-3xl mx-auto px-6 lg:px-8">
          <p className="text-gray-500 leading-relaxed mb-16 text-sm">
            株式会社ディーケー（以下「当社」）は、お客様の個人情報の保護を重要な責務と認識し、
