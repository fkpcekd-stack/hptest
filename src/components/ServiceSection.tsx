...
const illustrationsC = [
  ...
  <svg key="c1" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    <polygon points="0,300 400,300 400,200 0,300" fill={C} fillOpacity="0.04"/>
    <line x1="30"  y1="260" x2="370" y2="260" stroke={C} strokeOpacity="0.2" strokeWidth="2"/>
    {/* Bold ascending bars */}
    <rect x="52"  y="195" width="52" height="65" fill={C} fillOpacity="0.08" stroke={C} strokeOpacity="0.3" strokeWidth="2"/>
    <rect x="124" y="158" width="52" height="102" fill={C} fillOpacity="0.1" stroke={C} strokeOpacity="0.35" strokeWidth="2"/>
    <rect x="196" y="115" width="52" height="145" fill={C} fillOpacity="0.12" stroke={C} strokeOpacity="0.4" strokeWidth="2"/>
    <rect x="268" y="62"  width="52" height="198" fill={A} fillOpacity="0.18" stroke={A} strokeOpacity="0.75" strokeWidth="2" className="svg-anim" style={{ animation: "svgPulse 3s ease-in-out infinite" }}/>
    {/* Bold trend arrow */}
    <polyline points="78,195 150,158 222,115 294,62" stroke={A} strokeOpacity="0.8" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
    <polygon points="282,45 310,45 296,70" fill={A}/>
    {/* Bold corner */}
  ...
  <svg key="c2" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    <circle cx="200" cy="148" r="130" stroke={C} strokeOpacity="0.15" strokeWidth="2.5"/>
    <circle cx="200" cy="148" r="95"  stroke={C} strokeOpacity="0.22" strokeWidth="2.5" className="svg-anim" style={{ animation: "svgPulse 4s ease-in-out infinite" }}/>
    <circle cx="200" cy="148" r="62"  stroke={A} strokeOpacity="0.5"  strokeWidth="2.5"/>
    <circle cx="200" cy="148" r="32"  fill={A}   fillOpacity="0.18"  stroke={A} strokeOpacity="0.8" strokeWidth="2.5"/>
    <circle cx="200" cy="148" r="12"  fill={A}   fillOpacity="0.8"   className="svg-anim" style={{ animation: "svgCorePulse 2.5s ease-in-out infinite" }}/>
    {/* Bold crosshair */}
    <line x1="200" y1="15"  x2="200" y2="52"  stroke={A} strokeOpacity="0.6" strokeWidth="2.5"/>
    <line x1="200" y1="244" x2="200" y2="281" stroke={A} strokeOpacity="0.6" strokeWidth="2.5"/>
    <line x1="15"  y1="148" x2="52"  y2="148" stroke={A} strokeOpacity="0.6" strokeWidth="2.5"/>
    <line x1="348" y1="148" x2="385" y2="148" stroke={A} strokeOpacity="0.6" strokeWidth="2.5"/>
  ...
  <svg key="c3" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    <circle cx="148" cy="148" r="110" fill={C} fillOpacity="0.07" stroke={C} strokeOpacity="0.4" strokeWidth="2.5"/>
    <circle cx="252" cy="148" r="110" fill={A} fillOpacity="0.1"  stroke={A} strokeOpacity="0.6" strokeWidth="2.5" className="svg-anim" style={{ animation: "svgPulse 3.5s ease-in-out infinite" }}/>
    {/* Intersection fill */}
    <path d="M200,60 A110,110 0 0 1 200,236 A110,110 0 0 1 200,60 Z" fill={A} fillOpacity="0.18"/>
    <circle cx="200" cy="148" r="18" fill={A} fillOpacity="0.8" className="svg-anim" style={{ animation: "svgCorePulse 2.5s ease-in-out infinite" }}/>
    <line x1="28"  y1="28"  x2="62"  y2="28"  stroke={C} strokeOpacity="0.3" strokeWidth="2.5"/>
    <line x1="28"  y1="28"  x2="28"  y2="62"  stroke={C} strokeOpacity="0.3" strokeWidth="2.5"/>
    <line x1="372" y1="272" x2="338" y2="272" stroke={A} strokeOpacity="0.5" strokeWidth="2.5"/>
    <line x1="372" y1="272" x2="372" y2="238" stroke={A} strokeOpacity="0.5" strokeWidth="2.5"/>
  ...
  /* C04 コンテンツ事業 — ブロードキャスト */
  <svg key="c4" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    {/* Bold radio waves */}
    <path d="M60,260 A200,200 0 0 1 340,260" stroke={C} strokeOpacity="0.1"  strokeWidth="2.5" fill="none"/>
    <path d="M88,230 A160,160 0 0 1 312,230" stroke={C} strokeOpacity="0.16" strokeWidth="2.5" fill="none"/>
    <path d="M115,200 A120,120 0 0 1 285,200" stroke={A} strokeOpacity="0.35" strokeWidth="2.5" fill="none"/>
    <path d="M140,172 A80,80   0 0 1 260,172" stroke={A} strokeOpacity="0.55" strokeWidth="2.5" fill="none" className="svg-anim" style={{ animation: "svgBlink 3s ease-in-out infinite" }}/>
    {/* Bold play circle */}
    <circle cx="200" cy="260" r="55" fill={A} fillOpacity="0.15" stroke={A} strokeOpacity="0.7" strokeWidth="2.5" className="svg-anim" style={{ animation: "svgPulse 3s ease-in-out infinite" }}/>
    <polygon points="185,238 185,282 228,260" fill={A}/>
    {/* Broadcast source dot */}
    <circle cx="200" cy="120" r="14" fill={C} fillOpacity="0.7"/>
    <circle cx="200" cy="120" r="22" stroke={A} strokeOpacity="0.4" strokeWidth="2" fill="none"/>
    <line x1="200" y1="134" x2="200" y2="172" stroke={A} strokeOpacity="0.4" strokeWidth="1.5"/>
    <line x1="28"  y1="28"  x2="62"  y2="28"  stroke={C} strokeOpacity="0.3" strokeWidth="2.5"/>
    <line x1="28"  y1="28"  x2="28"  y2="62"  stroke={C} strokeOpacity="0.3" strokeWidth="2.5"/>
    <line x1="372" y1="272" x2="338" y2="272" stroke={A} strokeOpacity="0.5" strokeWidth="2.5"/>
    <line x1="372" y1="272" x2="372" y2="238" stroke={A} strokeOpacity="0.5" strokeWidth="2.5"/>
  ...
  <svg key="c5" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    {/* Left person */}
    <circle cx="108" cy="80"  r="35" fill={C} fillOpacity="0.1" stroke={C} strokeOpacity="0.45" strokeWidth="2.5"/>
    <path d="M62,228 C62,178 80,155 108,155 C136,155 154,178 154,228" fill={C} fillOpacity="0.08" stroke={C} strokeOpacity="0.4" strokeWidth="2.5"/>
    {/* Right person */}
    <circle cx="292" cy="80"  r="35" fill={A} fillOpacity="0.14" stroke={A} strokeOpacity="0.65" strokeWidth="2.5" className="svg-anim" style={{ animation: "svgPulse 3.5s ease-in-out infinite" }}/>
    <path d="M246,228 C246,178 264,155 292,155 C320,155 338,178 338,228" fill={A} fillOpacity="0.1" stroke={A} strokeOpacity="0.55" strokeWidth="2.5"/>
    {/* Bold bridge */}
    <line x1="154" y1="155" x2="246" y2="155" stroke={A} strokeOpacity="0.6" strokeWidth="3"/>
    <circle cx="200" cy="155" r="18" fill={A} fillOpacity="0.25" stroke={A} strokeOpacity="0.7" strokeWidth="2.5" className="svg-anim" style={{ animation: "svgCorePulse 2.5s ease-in-out infinite" }}/>
    <circle cx="200" cy="155" r="7"  fill={A}/>
    {/* Connection arc */}
    <path d="M108,45 Q200,5 292,45" stroke={A} strokeOpacity="0.4" strokeWidth="2" fill="none" strokeLinecap="round"/>
    <line x1="28"  y1="28"  x2="62"  y2="28"  stroke={C} strokeOpacity="0.3" strokeWidth="2.5"/>
    <line x1="28"  y1="28"  x2="28"  y2="62"  stroke={C} strokeOpacity="0.3" strokeWidth="2.5"/>
    <line x1="372" y1="272" x2="338" y2="272" stroke={A} strokeOpacity="0.5" strokeWidth="2.5"/>
    <line x1="372" y1="272" x2="372" y2="238" stroke={A} strokeOpacity="0.5" strokeWidth="2.5"/>
...
const SETS: Record<AnimStyle, React.ReactElement[]> = {
  A: illustrationsA,
  B: illustrationsB,
  C: illustrationsC,
  D: illustrationsD,
...
export default function ServiceSection({ services }: { services: Service[] }) {
  ...
  const illustrations = SETS[style];
